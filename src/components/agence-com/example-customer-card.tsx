    ...
    return (
        <>
            ...
            <div className={'max-w-[1000px] mx-auto hidden md:block'}>
                ...
                <div
                    className={`w-full bg-[#F78E3D] h-[500px] rounded-[50px] mt-6 lg:mt-8 grid grid-cols-1 lg:grid-cols-2`}>
                    ...
                    <div className={`${data.reversed ? 'lg:ml-20' : 'lg:-ml-20'} space-y-5`}>
                        ...
                        <div className={`text-white text-xs lg:text-sm text-justify ${data.reversed ? 'w-[90%] mx-auto lg:w-full lg:mx-0' : 'w-[90%] mx-auto lg:mx-0 lg:w-[80%]'}`}>
                            <p>{data.description}</p>
                            {data.images && (
                                <div className={'w-3/4 mx-auto mt-8 mb-4 lg:w-full'}>
                                    <ExampleCustomerImagesCarousel images={data.images} />
